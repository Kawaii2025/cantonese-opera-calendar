...
if (container) {
    ...
    const AppHeader = ({ currentDate, setCurrentDate }) => {
        ...
        const menuItems = [
            {
                key: '/',
                label: _jsx(Link, { to: "/", children: "\u65E5\u5386" }),
            },
            {
                key: '/admin',
    ...
    const RootApp = () => {
        ...
        return (_jsx(Router, { children: _jsxs(Layout, { style: { minHeight: '100vh' }, children: [_jsx(AppHeader, { currentDate: currentDate, setCurrentDate: setCurrentDate }), _jsx(Layout.Content, { style: { paddingTop: 0 }, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(CalendarApp, { currentDate: currentDate, onDateChange: setCurrentDate }) }), _jsx(Route, { path: "/admin", element: _jsx(AdminPage, {}) })] }) })] }) }));
    };
    const CalendarApp = ({ currentDate, onDateChange }) => {
        ...
        const dateCellRender = (value) => {
            ...
            const renderItem = (item, index) => {
                ...
                return (_jsxs("li", { className: "item-troupe", children: [_jsxs(Flex, { gap: "4px 0", wrap: true, align: "center", children: [troupeRender(item.troupe), cityRender(item.city), _jsx("span", { style: { fontSize: '12px', color: '#666', lineHeight: '20px', height: '20px', display: 'inline-block' }, children: timeLabel }), locationRender(item.location)] }), _jsx("span", { className: "item-content item-play-name", children: content })] }, index));
            };
        ...
        return (_jsxs("div", { className: "calendar-wrapper", children: [_jsxs("div", { style: {
                        display: 'flex',
                        justifyContent: 'flex-end',
                        padding: '16px 24px',
                        gap: 16
                    }, children: [_jsx(ExportImage, { events: events, currentDate: currentDate }), _jsxs(Radio.Group, { value: viewMode, onChange: (e) => setViewMode(e.target.value), buttonStyle: "solid", children: [_jsx(Radio.Button, { value: "calendar", children: "\u65E5\u5386" }), _jsx(Radio.Button, { value: "list", children: "\u5217\u8868" })] })] }), error && (_jsx(Alert, { message: "\u9519\u8BEF", description: error, type: "error", showIcon: true, closable: true, onClose: () => setError(null), style: { marginBottom: 16, margin: '0 24px' } })), _jsx(Spin, { spinning: loading, tip: "\u52A0\u8F7D\u4E2D...", children: viewMode === 'calendar' ? (_jsx(CustomCalendar, { cellRender: (date) => dateCellRender(date), value: currentDate, onChange: onDateChange, onCellClick: handleCellClick })) : (_jsx(MobileCardView, { currentDate: currentDate, events: events, onEventClick: (event) => {
